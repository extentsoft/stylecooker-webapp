...
browser.on('http', function(meth,path,data){
  console.log(' > ' + meth.megenta, path, (data || '').grey);
});
*/
...
describe('Inventory Index', function(){
  ...
  it('display a number of items on inventory index', function(done){
    browser.elementsByCssSelector('.item-summary')
      .should.eventually.have.length.about(0).notify(done);
  });
